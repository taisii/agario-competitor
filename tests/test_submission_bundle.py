...
from strategies.champion import ChampionStrategy, EnemyTrack, OwnBlob, _speed  # noqa: E402
...
def test_submission_bundle_is_single_file_without_local_imports() -> None:
    ...
    assert "class ChampionStrategy" in source
...
def test_censored_predator_track_advances_toward_vulnerable_blob() -> None:
    strategy = ChampionStrategy(depth=1, width=1, angular_samples=4)
